    ...
    while True:
        ...
        for b, x in enumerate(train_queue):
            ...
            if local_rank == 0 and b % args.log_iter == 0:
                ...
                vutils.save_image(syn, args.save + f'/images/{global_step:>07d}.png',
                                  nrow=int(math.floor(math.sqrt(args.batch_size))),
                                  normalize=True)
...
if __name__ == '__main__':
    ...
    parser.add_argument("--backbone", type=str, default='CIFAR10_Gaussian_Decoder')
    ...
    parser.add_argument('--nprocs', type=int, default=1, help='port for master')
